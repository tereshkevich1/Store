...
import com.example.store.feature.profile.presentation.components.PurchaseHistoryItem
    ...
    LaunchedEffect(Unit) {
        lifecycleOwner.lifecycleScope.launch {
            viewModel.events
                ...
                .collect {
                    when (it) {
                        ProfileScreeEvent.NavigateToDetailsScreen -> onDetailsScreenNavigate()
    ...
    StoreTheme {
        Surface(
            ...
            Column(
                ...
                PurchaseHistoryItem({}, "2000 BYN", "02.04.2025 - 14:51")
                PurchaseHistoryItem({}, "2000 BYN", "02.04.2025 - 14:51")
                PurchaseHistoryItem({}, "2000 BYN", "02.04.2025 - 14:51")
            }
        }
